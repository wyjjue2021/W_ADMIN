...
const SearchForm = (props) => {
  ...
  const handleSubmit = (values) => {
    ...
    listStore.searchParams.name = values.name;
    listStore.searchParams.gmtBegin = values.gmtBegin.format('YYYY-MM-DD');
    listStore.searchParams.gmtEnd = values.gmtEnd.format('YYYY-MM-DD');
    listStore.qryTableDate();
    // console.log(values);
  };
...
export default inject('listStore')(observer(SearchForm));
